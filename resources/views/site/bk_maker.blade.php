                ...
                $.ajax({
                    ...
                    success: function(svgString) {
                        ...
                        fabric.loadSVGFromString(svgString, function(objects, options) {
                            // Calculate the center of the canvas based on your custom logic
                            @php
                                $iconLeft = 2;
                                $iconTop = 2;
                            ...
                            ungroupedObjects.forEach(function(obj, index) {
                                // Adjust the object positions to center the bounding box
                                obj.set({
                                    // left: obj.left + canvasCenter.left - group
                                    //     .getBoundingRect().left,
                                    // top: obj.top + canvasCenter.top - group
                                    //     .getBoundingRect().top,
                                    selectable: true,
                                    evented: true
                                });
